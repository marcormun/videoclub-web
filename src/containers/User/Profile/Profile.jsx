...
const Delete = () => {
    axios.delete("https://videoclub-proyecto5.herokuapp.com/api/users", {headers:{id: userData.user_mail}}    );
    console.log(userData);
};
const Update = () => {
    axios.put("https://videoclub-proyecto5.herokuapp.com/api/users", {headers:{id: userData.user_mail}}    );
    console.log(userData);
    console.log("update");
};
